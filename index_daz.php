...
Your experience will showcase in the best Queenstown has to offer including fine food, exhilarating roads and world-renowned scenery.
            ...
            <div id="close"><a href="#"><img src='images/closeBtn.png' /></a></div>
				<form action="addDealer.php" method="GET">
                    ...
                    <p>
                    Date of Event: Please confirm you are available to travel <span>insert dates here</span>
                    </p>
                    <p>
                    PERSONAL DETAILS
                    </p>
					...
					<select name="title" id="title">
						...
						<div class="contactDetails">
								...
								<div class="line whiteLine"></div>
								<div class="row1 mail">
									<label for="MailAddress">Mailing Address*</label><input type="text" name="MailAddress" id="MailAddress" value="" />
								</div>
								<div class="row1 phone">
									<label for="phoneNumber">Phone number*</label><input type="text" name="phoneNumber" id="phoneNumber" value="" />
								</div>
                                <div class="row1 phone">
									<label for="phoneNumber">Pick Up Address*</label><input type="text" name="pickUp" id="pickUp" value="" />
								</div>
								
                                <label for name="guest">Will you be extending your stay in QeensTown?</label>
                                <div class="sizes ">
